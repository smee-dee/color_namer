class ColorNamer::ColorNames
  def self.names # List taken from http://chir.ag/tech/download/ntc
    [
      ...
      ['#E35BD8', 'Free Speech Magenta', 'Violet'],
      ...
      ['#647D86', 'Hoki', 'Blue'],
      ['#25342B', 'Holly', 'Green'],
      ['#F400A1', 'Hollywood Cerise', 'Violet'],
      ...
      ['#FF00CC', 'Hot Magenta', 'Violet'],
      ['#FF69B4', 'Hot Pink', 'Violet'],
      ...
      ['#BDBBD7', 'Lavender Grey', 'Violet'],
      ['#FBAED2', 'Lavender Pink', 'Violet'],
      ['#FBA0E3', 'Lavender Rose', 'Violet'],
      ...
      ['#C71585', 'Medium Violet Red', 'Violet'],
      ...
      ['#7A4434', 'Peanut', 'Brown'],
      ['#D1E231', 'Pear', 'Green'],
      ['#DED1C6', 'Pearl Bush', 'Brown'],
      ['#EAE0C8', 'Pearl Lusta', 'Brown'],
      ['#766D52', 'Peat', 'Green'],
      ...
      ['#F77FBE', 'Persian Pink', 'Violet'],
      ['#683332', 'Persian Plum', 'Red'],
      ['#CC3333', 'Persian Red', 'Red'],
      ['#FE28A2', 'Persian Rose', 'Violet'],
      ...
      ['#FF33CC', 'Razzle Dazzle Rose', 'Violet'],
      ...
      ['#FC0FC0', 'Shocking Pink', 'Violet'],
      ['#61666B', 'Shuttle Grey', 'Grey'],
      ['#686B50', 'Siam', 'Green'],
      ['#E9D9A9', 'Sidecar', 'Brown'],
      ['#A0522D', 'Sienna', 'Brown'],
      ['#BBADA1', 'Silk', 'Brown'],
      ['#C0C0C0', 'Silver', 'Grey'],
      ...
      ['#CFBEA5', 'Soft Amber', 'Brown'],
      ['#EEDFDE', 'Soft Peach', 'Red'],
      ['#85494C', 'Solid Pink', 'Red'],
      ['#EADAC2', 'Solitaire', 'Brown'],
      ...
      ['#DED1B7', 'Spanish White', 'Brown'],
      ['#375D4F', 'Spectra', 'Green'],
      ['#6C4F3F', 'Spice', 'Brown'],
      ['#8B5F4D', 'Spicy Mix', 'Brown'],
      ['#FF1CAE', 'Spicy Pink', 'Violet'],
      ['#B3C4D8', 'Spindle', 'Blue'],
